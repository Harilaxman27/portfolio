  ...
  return (
    <aside className="dark-surface p-6 lg:p-8 lg:sticky lg:top-6 lg:max-h-[calc(100vh-3rem)] lg:overflow-hidden no-scrollbar">
      <div className="flex flex-col items-center text-center lg:text-left lg:items-start">
        <div className="size-32 lg:size-40 rounded-3xl overflow-hidden bg-white/5 ring-1 ring-white/10">
      ...
      <div className={`${open ? "block" : "hidden"} lg:block`}>
        ...
        <ul className="space-y-4">
          <li className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <a href={`mailto:${profile.email}`} className="block truncate text-sm font-medium text-white/90 hover:text-[#DDF3F5]">
                {profile.email}
              </a>
            </div>
          </li>
        ...
        <div className="mt-6 flex items-center gap-4 text-white/55">
          ...
          <a href={profile.socials.dribbble} aria-label="Dribbble" className="hover:text-[#DDF3F5] transition-colors"><Dribbble className="size-4" /></a>
